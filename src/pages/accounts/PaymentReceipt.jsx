                  ...
                  render() {
                    return (
                      ...
                      <Paper elevation={5}>
                        ...
                        <h4 className='ml-3'>Add New Payment Receipt</h4>
                        <hr/>
                        <Form>
                          <Form.Row className='ml-3'>
                          <Form.Group className='ml-3' controlId="paymentreceiptno" >
                              <Form.Label>Payment Receipt No *</Form.Label>
                              <Form.Control type="text" placeholder="Payment Receipt No" />
                               </Form.Group>

                            <Form.Group className='ml-3' controlId="pydate">
                              <Form.Label>Payment Receipt Date *</Form.Label>
                              <Form.Control type="date" placeholder="Payment Receipt Date" />
                            </Form.Group>
                          </Form.Row>
                          ...
                          <Form.Row className='ml-3' >
                              <Form.Group className='ml-3' controlId="supplierlist" >
                              <Form.Label>Supplier List *</Form.Label>
                              <Form.Control as="select">
                                <option>Supplier List-01</option>
                                <option>Supplier List-02</option>
                              </Form.Control >
                              <Button className='mt-3'  variant='primary'>Search Supplier</Button>
                               </Form.Group>
                          </Form.Row>
                            <Form.Row className='ml-3' >
